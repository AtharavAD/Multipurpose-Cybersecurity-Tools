...
label = tk.Label(window, text="EXIF", font=('Inter', 30, 'bold'), fg='#000f46')
...
def open_specific_file2():
    ...
    # Specify the path to the Python script you want to open
    file_path = "D:\\Multipurpose Cybersecurity Tool\\UI\\03_tools manual\\Warning\\exif_Warning.py"
...
Insights_text = """Advantages:
  ...
  1. Stores metadata within image files, containing valuable information.
  2. Helps in understanding image details like camera settings, location, etc.
3. Organizational Use: Useful for cataloguing and organizing image data.



Disadvantages:

  1. Privacy concerns as it may contain sensitive location or device details.
  2. Can potentially reveal information unintentionally.
3. Limited Data: Not all images contain comprehensive or relevant metadata.
"""

Application_text = """Applications:

1.   Metadata Storage:   Storing metadata containing details about image settings and locations.
2.   Image Analysis:   Providing insights into camera settings and image-related information.
3.   Organizational Use:   Utilizing metadata for cataloguing and organizing image data.
"""
