...
label = tk.Label(window, text="SOFTWARE ENGINEERING", font=('Inter', 30, 'bold'), fg='#000f46')
...
image1 = PhotoImage(file="D:\\Multipurpose Cybersecurity Tool\\UI.png")
...
def open_specific_file2():
    ...
    # Specify the path to the Python script you want to open
    file_path = "D:\\Multipurpose Cybersecurity Tool\\UI\\03_tools manual\\Warning\\soft_engg_Warning.py"
...
Insights_text = """Advantages:
  ...
  1. Systematic approach to developing high-quality software.
  2. Follows established methodologies for efficient development.
3. Efficiency Improvement: Enhances efficiency through structured processes.



Disadvantages:

  1. Time-consuming and resource-intensive, especially in larger projects.
  2. Rigidity in certain methodologies may not suit all projects or teams.
3. Complexity: Processes can be complex and challenging for certain teams.
"""

Application_text = """Applications:

1.   Structured Development:   Applying systematic methodologies for software development.
2.   Quality Assurance:   Ensuring high-quality and reliable software products.
3.   Efficiency Improvement:   Enhancing efficiency through structured development processes.
"""
