...
label = tk.Label(window, text="   File Password Cracker", font=('Inter', 30, 'bold'), fg='#000f46')
...
def open_specific_file2():
    ...
    file_path = "D:\\Multipurpose Cybersecurity Tool\\Tools\\File_Password_Cracker.py"
    # Use subprocess to execute the Python script
    try:
        subprocess.Popen(["python", file_path], shell=True)
    except Exception as e:
...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Introduction_text = """Software or scripts designed to systematically attempt various password 
combinations to gain unauthorized access to password-protected files. These 
tools are often used for ethical purposes, such as password recovery or security 
testing.

1. Overview: A software or script that systematically attempts various password 
    combinations to gain unauthorized access to password-protected files.
2. Purpose: Ethical applications include password recovery or security testing to 
    assess the strength of file protection mechanisms.
3. Functionality: Employs brute-force or dictionary attack methods to crack 
    passwords, emphasizing the need for strong and secure passwords.
"""
...
1. Password Recovery: Useful for recovering forgotten passwords and gaining 
    authorized access to protected files.
2. Security Testing: Employed for ethical purposes to assess the strength 
    of password protection mechanisms.
3. Efficiency: Can be more time-efficient than manual attempts, especially 
    for complex passwords.

Disadvantages:

1. Misuse Potential: Prone to misuse for unauthorized access, leading to security 
    breaches and privacy violations.
2. Resource Intensive: Depending on the complexity of passwords, the process can 
    be computationally intensive.
3. Legality Concerns: Use in unauthorized scenarios can violate privacy laws and 
    ethical standards.
...
1.Forgotten Password Recovery: Used to regain access to files when passwords 
   are forgotten.
2.Security Audits: Employed by security professionals to test the strength of 
   password protection mechanisms.
3.Educational Tools: Used for training and educational purposes to understand 
   password security risks.
"""

Result = PhotoImage(file= 'D:\\Multipurpose Cybersecurity Tool\\UI\\03_tools manual\\Result_Images\\pdf pass.png')
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
