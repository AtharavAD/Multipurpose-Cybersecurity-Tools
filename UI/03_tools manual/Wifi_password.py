...
label = tk.Label(window, text="WI-FI PASSWORD RETRIEVAL", font=('Inter', 30, 'bold'), fg='#000f46')
...
def open_specific_file2():
    ...
    # Specify the path to the Python script you want to open
    file_path = "D:\\Multipurpose Cybersecurity Tool\\Tools\\N_wifi.py"
...
1. Helps access forgotten WIFI passwords.
2. Useful for network troubleshooting and reconnection.
3. Troubleshooting Aid: Helps diagnose network connectivity issues.



Disadvantages:

1. Unauthorized retrieval can violate privacy and legal regulations.
2. May require specific permissions or administrative access.
3. Device Limitation: May not work on all devices or router models.
"""

Application_text = """Applications:

1. Access Restoration: Recovering forgotten or lost Wi-Fi passwords for 
    reconnection.
2. Network Setup: Assisting in configuring new devices to connect to the network.
3. Troubleshooting: Helping diagnose issues related to connectivity or access.
"""

Result = PhotoImage(file= 'D:\\Multipurpose Cybersecurity Tool\\UI\\03_tools manual\\Result_Images\\wifi pass.png')
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
